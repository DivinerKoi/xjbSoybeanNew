...
export const generatedRoutes: GeneratedRoute[] = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        name: 'article_course',
        path: '/article/course',
        component: 'view.article_course',
        meta: {
          title: 'article_course'
        }
      }
    ]
  },
  ...
  },
  {
    name: 'grade',
    path: '/grade',
    component: 'layout.base$view.grade',
    meta: {
      title: 'grade'
    }
  },
  ...
  },
  {
    name: 'preview',
    path: '/preview',
    component: 'layout.base$view.preview',
    meta: {
      title: 'preview'
    }
  },
  {
    ...
    children: [
      ...
      },
      {
        name: 'product_order',
        path: '/product/order',
        component: 'view.product_order',
        meta: {
          title: 'product_order'
        }
      },
      {
        name: 'product_prod-info',
        path: '/product/prod-info',
        component: 'view.product_prod-info',
        meta: {
          title: 'product_prod-info'
        },
        children: [
          {
            name: 'product_prod-info_prod-sku',
            path: '/product/prod-info/prod-sku',
            component: 'view.product_prod-info_prod-sku',
            meta: {
              title: 'product_prod-info_prod-sku'
            }
          }
        ]
      }
  ...
  },
  {
    name: 'room',
    path: '/room',
    component: 'layout.base$view.room',
    meta: {
      title: 'room'
    }
  },
  {
    name: 'room-service',
    path: '/room-service',
    component: 'layout.base$view.room-service',
    meta: {
      title: 'room-service'
    }
  },
  {
    name: 'shop',
    path: '/shop',
    component: 'layout.base$view.shop',
    meta: {
      title: 'shop'
    }
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          {
            name: 'system_dict_dict-data',
            path: '/system/dict/dict-data/:dictId',
            component: 'view.system_dict_dict-data',
            meta: {
              title: 'system_dict_dict-data',
              i18nKey: 'route.system_dict_dict-data'
            }
          }
        ]
      },
      {
        ...
        children: [
          {
            name: 'system_log_login-log',
            path: '/system/log/login-log',
            component: 'view.system_log_login-log',
            meta: {
              title: 'system_log_login-log',
              i18nKey: 'route.system_log_login-log'
            }
          },
          {
            name: 'system_log_oper-log',
            path: '/system/log/oper-log',
            component: 'view.system_log_oper-log',
            meta: {
              title: 'system_log_oper-log',
              i18nKey: 'route.system_log_oper-log'
            }
          }
        ]
      },
      {
        ...
        component: 'view.system_materials',
        meta: {
          title: 'system_materials'
        }
      },
      {
        name: 'system_menu',
